...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Chelsea blue radial centre glow */}
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 60% 50% at 50% 60%, rgba(3,70,148,0.12), transparent)" }} />

      {/* Mouse-following glow */}
      <div
        className="absolute inset-0 opacity-20 transition-all duration-1000 pointer-events-none"
        style={{ background: `radial-gradient(600px circle at ${mousePos.x}% ${mousePos.y}%, rgba(3,70,148,0.08), transparent 60%)` }}
      />

      {/* Floating orbs */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[#034694]/[0.04] rounded-full blur-3xl animate-float-slow" />
      <div className="absolute bottom-1/4 right-1/3 w-48 h-48 bg-white/[0.015] rounded-full blur-3xl animate-float-slower" />
      <div className="absolute top-1/3 right-1/4 w-32 h-32 bg-[#034694]/[0.03] rounded-full blur-2xl animate-float-medium" />

      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        {/* Status badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm mb-8 animate-fade-in-up">
          <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
          <span className="text-xs text-white/50 font-mono tracking-wider uppercase">Available for opportunities</span>
        </div>
        ...
        {/* Typewriter */}
        <div className="text-xl sm:text-2xl md:text-3xl text-white/40 mb-6 h-10 animate-fade-in-up animation-delay-200">
          <TypeWriter
            words={[
        ...
        {/* Tagline */}
        <p className="text-base sm:text-lg text-white/30 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up animation-delay-300">
        ...
        {/* Location + socials */}
        <div className="flex items-center justify-center gap-6 text-white/25 text-sm animate-fade-in-up animation-delay-500">
